    ...
    void LateUpdate()
    {
        ...
        */
        ...
        { */
            ...
            smoothRot.x = ClampAngle(tOrigin.eulerAngles.x + (Input.GetAxis(verticalCamAxis)) + (Input.GetAxis(verticalCamAxisGamepad)), VerticalAngleMinMax.x, VerticalAngleMinMax.y);
            tOrigin.eulerAngles = smoothRot;*/
